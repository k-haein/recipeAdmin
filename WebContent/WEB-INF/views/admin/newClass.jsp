									...
									<tr>
										...
										<td width="10%"><a
											href='class_write?class_no=${newList.class_no}'>
												<div align="center">
													<img
														src="${pageContext.request.contextPath}/../RecipePrj_01/resources/image/FoodImg/${newList.class_thumbnail}"
														width="100px">
									...
									<tr>
										...
										<td width="10%"><a
											href='class_write?class_no=${aplList.class_no}'>
												<div align="center">
													<img
														src="${pageContext.request.contextPath}/../RecipePrj_01/resources/image/FoodImg/${aplList.class_thumbnail}"
														width="100px">
