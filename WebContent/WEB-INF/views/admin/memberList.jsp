...
<script>
	...
	$(document).on('click', '#btnchef', function(e) {
		e.preventDefault();
		var url = "${memberList}";
		url = url + "?searchType=mem_grade_no";
		url = url + "&keyword=쉐프";
		location.href = encodeURI(url);
		console.log(url);
	})
	$(document).on('click', '#btnmem', function(e) {
		e.preventDefault();
		var url = "${memberList}";
		url = url + "?searchType=mem_grade_no"
		url = url + "&keyword=일반인";
	...
	<div class="container-fluid">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				<div align='right'>
					<input type='button' id='btnchef' value='쉐프전체보기'
						class="btn btn-outline-info">&nbsp
						 <input type='button'
						id='btnmem' value='일반인전체보기' class="btn btn-outline-info">&nbsp
